            ...
            <div className="flex flex-col justify-between p-4 space-y-4">
                <div className="space-y-2">
                    ...
                    <div className="flex justify-between py-4">
                        <Link to={`featuredSurvey/${fedData._id}`}>
                ...
                <button type="button" className="flex items-center justify-center w-full p-3 font-semibold track rounded-md dark:bg-violet-400 dark:text-gray-900 border bg-green-200">View Details</button>
            </div>
        </div>
    );
};
